...
import com.example.frontend.model.SchedaPazienteForm;
import com.example.frontend.service.InterfaceFarmaciaService;
import com.example.frontend.service.InterfaceMalattiaStub;
import com.example.frontend.service.InterfacePazienteService;
import com.example.frontend.service.InterfacePazienteStub;
...
public class PazientiController {
   ...
   */
  @Autowired
  private InterfaceFarmaciaService farmaciaService;

  /**
   * <p>Riferimento all'interfaccia malattia stub.</p>
   */
  @Autowired
  private InterfaceMalattiaStub malattiaStub;

  /**
   * <p>Riferimento all'interfaccia paziente stub.</p>
   */
  @Autowired
  private InterfacePazienteStub pazienteStub;
